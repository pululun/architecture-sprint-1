...
### Декомпозиция
* Исходя из бизнес функций монолита я решил разделить его на 13 микросервисов. 
...
* Заключительным событием, я бы перевёл "Микросервис управления заявками" и "Микросервис управления аукционами" в указанной последовательности. Исходя из связи "Заявка на аукцион.ID" которая была в монолите, можно сделать вывод, что эти микросервисы связаны, однако я думаю, что в будущем бизнес может захотеть, что бы пользователи имели возможность самостоятельно создавать аукционы и в них привязывать продукты\услуги.

П.С. В приложенном файле декомпозиция находится во второй вкладке "microservices", на схеме есть применение платформы "kafka", но не указана связь микросервисов на базе распределённой потоковой платформы "kafka", они будут указаны на другой схеме.
